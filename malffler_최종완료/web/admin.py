...
from .models import user , lecture1,lecture2 , lecture_page  , problem  ,boardAnwser , lecture3 ,boards , gpt_report , Progress , problem_exe , problem_exe_Progress, Virtualize
...
admin.site.register(Virtualize)
